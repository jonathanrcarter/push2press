...
$htop = $htop .'              		<li><a href="api.php?action=list-draft-mes"> Messages</a></li>';
$htop = $htop .'              <li <li class="dropdown" id="menu1"><a class="dropdown-toggle" data-toggle="dropdown" href="#menu3">Push Marketing</a>';// <b class="caret"></b></a>';
$htop = $htop .'              	<ul class="dropdown-menu">';
$htop = $htop .'              		<li><a href="api.php?action=list-group"><i class="icon-list-alt"></i> Groups</a></li>';
$htop = $htop .'              		<li><a href="api.php?action=list-log"><i class="icon-signal"></i> Devices</a></li>';
$htop = $htop .'              	</ul>';
$htop = $htop .'              </li>';
$htop = $htop .'              <li <li class="dropdown" id="menu1"><a class="dropdown-toggle" data-toggle="dropdown" href="#menu2">CMS</a>';// <b class="caret"></b></a>';
$htop = $htop .'              	<ul class="dropdown-menu">';
...
$htop = $htop .'              		<li><a href="api.php?action=list-stats-graph"><i class="icon-list-alt"></i> Graph</a></li>';
$htop = $htop .'              	</ul>';
$htop = $htop .'              </li>';
$htop = $htop . "\n";
$htop = $htop .' <script type="text/javascript">';
