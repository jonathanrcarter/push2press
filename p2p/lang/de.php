...
function L($phrase) {
	static $lang = array(
		...
		"DELETE" => "Delete",
		"PREVIEW" => "Preview",
		"List_conf" => "List of all configurations",
		"list_teach" => "List of all teachers",
		"List_rooster" => "List of all roosters",
		"log_phone" => "List of all devices",
		"groupz" => "List of all groups",
		"catz" => "List of all categories",
		"mesz" => "List of all messages",
