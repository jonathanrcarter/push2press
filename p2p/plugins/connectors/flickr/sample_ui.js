...
var fn = function(win,view) {
	...
	var search = require("/helpers/LocalStorage").getString("flickr_search1");
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("flickr_search1",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/kitchensink/plugins/connectors/flickr/search.php?srch="+search;
