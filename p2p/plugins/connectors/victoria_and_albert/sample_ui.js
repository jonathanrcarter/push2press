...
var fn = function(win,view) {
	...
	var search = require("/helpers/LocalStorage").getString("va_search1");
	if (search == null) search = "victoria";
	if (search == "") search = "victoria";
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("va_search1",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/kitchensink/plugins/connectors/victoria_and_albert/search.php?srch="+search;
		...
		loader.onload = function() {
			...
			for (var i = 0; i < items.length; i++) {  
				...
				formatpage(post_view,item.p2pitem.summary);
