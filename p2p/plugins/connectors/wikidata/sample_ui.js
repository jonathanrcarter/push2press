...
var fn = function(win,view) {
	...
	var search = require("/helpers/LocalStorage").getString("wikidata_search1");
	if (search == null) search = "Q35127";
	if (search == "") search = "Q35127";
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("wikidata_search1",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/kitchensink/plugins/connectors/wikidata/getpage.php?q="+search;
