wiz:#name:Europeana Open Culture - Art Theme
...
var fn = function(win,view) {
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("europeana_search",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/jc30/plugins/connectors/europeana_open_culture/search.php?theme="+THEME+"&srch="+search;
