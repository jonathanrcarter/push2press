wiz:#name:Europeana Open Culture

var COOKIE = "europeana_search";

var fn = function(win,view) {
	win.backgroundColor = "#000";

	var search = require("/helpers/LocalStorage").getString(COOKIE);
	if (search == null) search = "vermeer";
	if (search == "") search = "vermeer";
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString(COOKIE,search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/jc30/plugins/connectors/europeana_open_culture/search.php?srch="+search;
