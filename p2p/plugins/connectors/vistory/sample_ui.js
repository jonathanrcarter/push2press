...
var fn = function(win,view) {
	...
	var search = require("/helpers/LocalStorage").getString("vistory_search1");
	if (search == null) search = "amsterdam";
	if (search == "") search = "amsterdam";
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("vistory_search1",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/kitchensink/plugins/connectors/vistory/search.php?srch="+search;
