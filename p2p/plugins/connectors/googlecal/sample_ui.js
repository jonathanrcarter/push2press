...
var fn = function(win,view) {
	...
	var search = require("/helpers/LocalStorage").getString("googlecal_search1");
	if (search == null) search = "2a805oltro8qj9i0eklanved9o%40group.calendar.google.com";
	if (search == "") search = "2a805oltro8qj9i0eklanved9o%40group.calendar.google.com";
	...
	var load_data = function(search) {	
		require("/helpers/LocalStorage").setString("googlecal_search1",search);

		tableview.setData([], {animate : true});

		var rowData = new Array();
		var twitterAPIrequest = "http://m.push2press.com/kitchensink/plugins/connectors/googlecal/search.php?srch="+search;
